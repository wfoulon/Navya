...
let boum = require('../../../../Resources/multicircle.png')
  ...
  render() {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={{...colorPaletteStyles.colorContainer, ...this.props.paletteStyles}}>
          {this.props.colors.map((color) => {
            return (
              ...
              >
                {color === 'BOUM' &&
                  <Image source={boum} style={{position: 'absolute', resizeMode: 'stretch', width: 30, height: 30}} />
                }
        ...
        <View style={{...colorPaletteStyles.colorContainer, ...this.props.paletteStyles}}>
          <TouchableOpacity
            style={{...colorPaletteStyles.colorOption, backgroundColor: '#FFFFFF', marginTop: 30}}
